...
with RvDAG(
        ...
        description='EMC Personal Contact',
        default_args={
    ...
    spark_job_operator = RLocalSparkOperator(
        task_id="new_and_total_personal_contact",
        project=CONTACT_REPORT,
        version=version,
        main_clazz='rever.etl.emc.PersonalContactRunner',
        arguments={
            ...
            "new_personal_contact_topic": 'rap.analytics.new_personal_contact',
            "total_personal_contact_topic": 'rap.analytics.total_personal_contact',
