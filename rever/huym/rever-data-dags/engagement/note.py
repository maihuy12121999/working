...
with RvDAG(
    ...
    spark_job_operator = RLocalSparkOperator(
        ...
        version=version,
        main_clazz='rever.etl.engagement.NoteRunner',
        arguments={
            ...
            "new_note_engagement_topic": 'rap.analytics.new_note_engagement',
