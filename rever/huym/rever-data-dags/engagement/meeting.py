...
#
with RvDAG(
        'new_meeting_engagement',
        owner='huym',
        emails=['huym@rever.vn'],
        description='Engagement Meeting',
        default_args={
    ...
    spark_job_operator = RLocalSparkOperator(
        ...
        version=version,
        main_clazz='rever.etl.engagement.MeetingRunner',
        arguments={
            ...
            'new_meeting_engagement_topic': 'rap.analytics.new_meeting_engagement',
