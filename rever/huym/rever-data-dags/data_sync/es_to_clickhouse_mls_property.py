...
#
with RvDAG(
        'es_to_clickhouse_mls_property',
        owner='anhlt',
        emails=['anhlt@rever.vn'],
        description='MLS Property To Clickhouse',
        default_args={
        ...
        end_date=None,
        catchup=True,
        tags=['Data Sync', 'MLS Property', 'ES -> ClickHouse'],
) as dag:
    from spark_job_synchronizer_factory import DATA_SYNC_JOB_PROJECT

    version = 'v8.3'

    sync_mls_operator = RLocalSparkOperator(
        task_id="sync_mls_property_to_clickhouse",
        project=DATA_SYNC_JOB_PROJECT,
        version=version,
        main_clazz='rever.etl.data_sync.MlsPropertyToClickhouseRunner',
        arguments={
            ...
            "CH_DB": 'datamart',
            "target_mls_property_table": 'mls_property',
