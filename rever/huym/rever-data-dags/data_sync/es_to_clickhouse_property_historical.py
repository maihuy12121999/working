...
#
with RvDAG(
        'es_to_clickhouse_property_historical',
        owner='anhlt',
        emails=['anhlt@rever.vn'],
        description='Sync ES Property History To Clickhouse',
        default_args={
        ...
        end_date=None,
        catchup=True,
        tags=['Data Sync', 'Property History', 'ES -> ClickHouse'],
) as dag:
    ...
    data_sync_job_operator = RLocalSparkOperator(
        task_id="sync_es_property_history_to_clickhouse",
        project=DATA_SYNC_JOB_PROJECT,
        version=version,
        main_clazz='rever.etl.data_sync.PropertyHistoryESToClickhouseRunner',
        arguments={
            ...
            "RV_ES_INDEX_NAME": 'tracking_data',
            "RV_RAP_INGESTION_HOST": Variable.get('RV_RAP_INGESTION_HOST'),
            "property_historical_topic": "rap.historical.es_rever_property",
