...
#
with RvDAG(
        'mysql_to_clickhouse_rever_clock_request',
        owner='anhlt',
        emails=['anhlt@rever.vn'],
        description='Sync Rever Clock Request To Clickhouse',
        default_args={
        ...
        end_date=None,
        catchup=True,
        tags=['Data Sync', 'MySQL -> ClickHouse', 'Rever Clock Request'],
) as dag:
    ...
    sync_clock_request_operator = RLocalSparkOperator(
        task_id="sync_sys_rever_clock_request_to_clickhouse",
        project=DATA_SYNC_JOB_PROJECT,
        version=version,
        main_clazz='rever.etl.data_sync.ClockRequestToCHRunner',
        arguments={
            ...
            "CH_DB": 'datamart',
            "source_table": 'clock_request',
            "target_table": 'rever_clock_request',
