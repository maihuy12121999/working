...
with RvDAG(
        'vision_tracker_visitor_ytd',
        owner='anhlt',
        emails=['anhlt@rever.vn'],
        description='Vision Tracker Visitor YTD',
        default_args={
        ...
        end_date=None,
        catchup=True,
        tags=['Vision Tracker', 'Visitor YTD'],
) as dag:
    ...
    spark_job_operator = RLocalSparkOperator(
        task_id="exec_visitor_ytd",
        project=VISION_TRACKER_REPORT_JOB_PROJECT,
        version=version,
        main_clazz='rever.etl.vision_tracker.YtdVisitorEntryPoint',
        arguments={
            ...
            "visitor_ytd_topic": 'rap.analytics.vision_tracker_visitor_ytd'
        }
    )
