...
with RvDAG(
        'isa_report_oppo_by_phase',
        owner='vyltn1',
        emails=['vyltn1@rever.vn'],
        description='Oppo by phase',
        default_args={
        ...
        end_date=None,
        catchup=True,
        tags=['ISA Dashboard', 'Oppo By Phase'],
) as dag:
    ...
    oppo_by_phase_operator = RLocalSparkOperator(
        ...
        version=version,
        main_clazz='rever.etl.isa.OppoByPhaseEntryPoint',
        arguments={
            ...
            "oppo_by_phase_topic": 'rap.analytics.isa_dashboard_oppo_by_phase',
            "pipeline_ids": '1034,1042,1002,1003,1043,1044'
        }
    )
