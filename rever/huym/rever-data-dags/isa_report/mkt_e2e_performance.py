...
with RvDAG(
        'marketing_e2e_oppo_owner_performance',
        owner='vyltn1',
        emails=['vyltn1@rever.vn'],
        description='Marketing Oppo Owner Performance',
        default_args={
        ...
        end_date=None,
        catchup=True,
        tags=['Marketing E2E', 'Oppo Owner Performance'],
) as dag:
    from spark_job_synchronizer_factory import ISA_REPORT_JOB_PROJECT

    version = 'v4.2'

    efficiency_works_operator = RLocalSparkOperator(
        task_id="exec_efficiency_works",
        project=ISA_REPORT_JOB_PROJECT,
        version=version,
        main_clazz='rever.etl.marketing.E2EOwnerPerformanceEntryPoint',
        arguments={
            ...
            "oppo_owner_performance_topic": 'rap.analytics.marketing_e2e_oppo_owner_performance'
        }
    )

    efficiency_works_operator
