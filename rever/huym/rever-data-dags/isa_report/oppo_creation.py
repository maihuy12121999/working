...
#
with RvDAG(
        'isa_report_oppo_creation',
        owner='vyltn1',
        emails=['vyltn1@rever.vn'],
        description='Oppo creation',
        default_args={
        ...
        end_date=None,
        catchup=True,
        tags=['ISA Dashboard', 'Oppo Creation'],
) as dag:
    from spark_job_synchronizer_factory import ISA_REPORT_JOB_PROJECT

    version = 'v4.5'

    oppo_creation_operator = RLocalSparkOperator(
        task_id="exec_oppo_creation",
        project=ISA_REPORT_JOB_PROJECT,
        version=version,
        main_clazz='rever.etl.isa.OppoCreatedEntryPoint',
        arguments={
            ...
            "oppo_created_topic": 'rap.analytics.isa_dashboard_oppo_created'
        }
    )

    oppo_creation_operator
