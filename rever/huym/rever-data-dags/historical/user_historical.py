...
with RvDAG(
        ...
        end_date=None,
        catchup=True,
        tags=['Historical', 'User'],
) as dag:
    from spark_job_synchronizer_factory import USER_REPORT

    version = 'v1.2'

    spark_job_operator = RLocalSparkOperator(
        task_id="user_historical",
        project=USER_REPORT,
        version=version,
        main_clazz='rever.etl.user.UserHistoricalRunner',
        arguments={
