...
#
with RvDAG(
        'personal_contact_historical',
        owner='huym',
        emails=['huym@rever.vn', 'anhlt@rever.vn'],
        description='Personal Contact Historical',
        default_args={
            'wait_for_downstream': False,
        },
        schedule_interval='13 0 * * *',
        # start_date=datetime(2020, 3, 20),
        start_date=datetime(2022, 11, 25),
        end_date=None,
        catchup=True,
        tags=['Historical', 'Personal Contact'],
) as dag:
    ...
    spark_job_operator = RLocalSparkOperator(
        task_id="personal_contact_historical",
        project=CONTACT_REPORT,
        version=version,
        main_clazz='rever.etl.emc.PersonalContactHistoricalRunner',
        arguments={
