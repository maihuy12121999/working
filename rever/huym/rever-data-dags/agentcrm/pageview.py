...
with RvDAG(
    ...
    spark_job_operator = RLocalSparkOperator(
        task_id="run_pageview_job",
        project=AGENTCRM_REPORT_PROJECT,
        version=version,
        main_clazz='rever.etl.agentcrm.PageviewAnalysisRunner',
        arguments={
            ...
            "page_view_topic": 'rap.analytics.agentcrm_pageview',
