...
object DelightedSurveyResponseToCHRunner extends BaseRunner {
  ...
  def main(args: Array[String]): Unit = {
    ...
    runWithDailyForceRun("rever.etl.data_sync.jobs.delighted_survey_response", config)
  }
}
