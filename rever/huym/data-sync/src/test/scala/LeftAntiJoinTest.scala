...
/** @author anhlt (andy)
  * @since 27/04/2022
  */
class LeftAntiJoinTest extends FunSuite {

  test("Account key to base64") {
    val accountkey =
      """
        |{
    ...
    val accountKeyBase64 = Base64.getEncoder.encodeToString(accountkey.getBytes("UTF-8"))

    println(accountKeyBase64)
  }
