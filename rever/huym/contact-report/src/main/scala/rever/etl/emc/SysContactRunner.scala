...
/** @author anhlt (andy)
  */
object SysContactRunner extends BaseRunner {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = Config
      ...
      .addArgument("new_sys_contact_topic", true)
      .addArgument("total_sys_contact_topic", true)
    ...
    val packageName = "rever.etl.emc.jobs.sys_contact"
