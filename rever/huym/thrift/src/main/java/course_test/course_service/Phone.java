...
public class Phone implements org.apache.thrift.TBase<Phone, Phone._Fields>, java.io.Serializable, Cloneable, Comparable<Phone> {
   ...
   * @see PhoneType
   */
  public @org.apache.thrift.annotation.Nullable PhoneType type; // required
  ...
  public Phone setNumber(@org.apache.thrift.annotation.Nullable java.lang.String number) {
    this.number = number;
    return this;
  }
   ...
   * @see PhoneType
   */
  public Phone setType(@org.apache.thrift.annotation.Nullable PhoneType type) {
    this.type = type;
    return this;
  }
